...
We use the fact, as we have implicitly already used to assert the form of $\rho$, that $L^2(\pi)$ is a vector space with basis $\{f_k\}$ to assert that the coefficients are equal
