...
We have
\begin{equation*}\dot{R}_{\uk} = \left(R_0-4\pi^2|\uk|^2\right)R_{\uk} + \sum\limits_{\substack{\ul\in\Z^2\\\ul\neq\underline0,\uk}} \frac{\ul\cdot\uk}{|\ul|^2}R_{\ul}R_{\uk-\ul}.\end{equation*}
Substitute $\uj=\ul-\frac\uk2$.  Then

\begin{equation*}\dot{R}_{\uk} = \left(R_0-4\pi^2|\uk|^2\right)R_{\uk} + \sum\limits_{\substack{\uj\in\Z^2+\frac{\text{mod}(\uk,2)}2\\\uj\neq\pm\frac\uk2}} \frac{(\uj+\frac\uk2)\cdot\uk}{|\uj+\frac\uk2|^2}R_{\frac\uk2+\uj}R_{\frac\uk2-\uj}\end{equation*}
...
\begin{equation*}\dot{R}_{\uk} = \left(R_0-4\pi^2|\uk|^2\right)R_{\uk} + \sum\limits_{\substack{0\leq\arctan\ujj<\pi\\\uj\in\Z^2+\frac{\text{mod}(\uk,2)}2\\\uj\neq\pm\frac\uk2}} \left(\frac{(\uj+\frac\uk2)\cdot\uk}{|\uj+\frac\uk2|^2}+\frac{(-\uj+\frac\uk2)\cdot\uk}{|-\uj+\frac\uk2|^2}\right)R_{\frac\uk2+\uj}R_{\frac\uk2-\uj}.\end{equation*}
We write the coefficients more explicitly:

\begin{multline*}
  \dot{R}_{\uk} = \left(R_0-4\pi^2|\uk|^2\right)R_{\uk} + \\
  \sum\limits_{\substack{0\leq\arctan\ujj<\pi\\\uj\in\Z^2+\frac{\text{mod}(\uk,2)}2\\\uj\neq\pm\frac\uk2}}
  \frac{|\uk|^2\left(|\uj|^2+\frac{|\uk|^2}4\right)-2(\uj\cdot\uk)^2}{\left(|\uj|^2-\uj\cdot\uk+\frac{|\uk|^2}4\right)\left(|\uj|^2+\uj\cdot\uk+\frac{|\uk|^2}4\right)}
  R_{\frac\uk2+\uj}R_{\frac\uk2-\uj}.
\end{multline*}
