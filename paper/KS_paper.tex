...
\begin{lemma}
	...
	\begin{align}
		...
		\forall n \in \N	&: \quad \cR_n \coloneqq \left( R_{n, a} \right)_{a \in \N} \in l^2 \left( \N \right), \label{eq:regularity} \\
...
\begin{proof}
	Let
	\begin{equation}
		C^\prime \coloneqq \inf \left( \left\{ \ c \ \middle| \ \forall \underline{k} \in Z_0 - \{ \underline{0} \} : \quad \left| R_{0, \underline{k}} \right| \leqslant c \exp \left( - \tfrac{\left| \underline{k} \right|}{c} \right) \ \right\} \right).
	\end{equation}
