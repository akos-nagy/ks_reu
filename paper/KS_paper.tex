...
\begin{lemma}
	...
	\begin{subequations}
	\begin{align}
		\forall n \in \N	&: \quad \left( R_{a, n} \right)_{a \in \N} \in l^2 \left( \N \right), \\
		\forall a, n \in \N	&: \quad R_{a, n + 1} = \frac{1}{n + 1} \left( \left( \tfrac{m}{A_\Sigma} - \lambda_a \right) R_{a, n} + \sum\limits_{b, c \in \N} \sum\limits_{m = 0}^n \frac{\lambda_a - \lambda_b + \lambda_c}{2 \lambda_c} \varphi_{abc} R_{b, m} R_{c, n - m} \right).
	\end{align}
	\end{subequations}
\end{lemma}
